...
public abstract class Bag {
     ...
     *
     * @return either the item that was popped from the contents, or null if there are no items in the bag
     */
    public String popItem() {
        if (this.getNumberOfContents() == 0) {
            ...
            String lastElement = this.contents[this.numberOfContents - 1];
            this.contents = newArr;
