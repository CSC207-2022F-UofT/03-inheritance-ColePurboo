...
public class CrossbodyBag extends Bag {
    ...
    /**
     * Creates a new CrossbodyBag with the given colour, capacity and number or straps
     * @param color
     * @param capacity
    ...
    public String toString(){
        return this.getColor() + " Crossbody Bag with " + this.numberOfStraps + " straps (" + super.getNumberOfContents() + " / " +
                super.getCapacity() + ")";
    }
}
